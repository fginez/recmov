function [input, target, input_n] = gera_matrizes3_1(Dados)
...
%     input_ = [Dados(i).Caracteristicas(2) ...       % media x
...
%               Dados(i).Caracteristicas(8) ...       % obliquidade x
%               Dados(i).Caracteristicas(9) ...       % obliquidade y
%               Dados(i).Caracteristicas(10) ...      % obliquidade z
%               Dados(i).Caracteristicas(11) ...      % curtose x
%               Dados(i).Caracteristicas(12) ...      % curtose y
%               Dados(i).Caracteristicas(23) ...      % curtose z
%               Dados(i).Caracteristicas(21) ...      % sem mov
